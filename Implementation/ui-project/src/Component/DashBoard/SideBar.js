...
function SideBar(props) {
    return (
        <div className={styles.mySidebar}>
            ...
            <div className={[styles.marginLeftSidebar, styles.containerButtonSideBar].join(" ")}><Link to="#" className={[styles.myLink, styles.myButtonSideBar].join(" ")}><i class="fa fa-upload"></i>&nbsp;Quản lý nhà xuất bản</Link></div>
            <div className={[styles.marginLeftSidebar, styles.containerButtonSideBar].join(" ")}><Link to="#" className={[styles.myLink, styles.myButtonSideBar].join(" ")}><i class="fa fa-list"></i>&nbsp;Quản lý thể loại sách</Link></div>
            <div className={[styles.marginLeftSidebar, styles.containerButtonSideBar].join(" ")}><Link to="#" className={[styles.myLink, styles.myButtonSideBar].join(" ")}><i class="fa fa-arrows-alt"></i>&nbsp;Quản lý mượn trả</Link></div>
            <div className={[styles.marginLeftSidebar, styles.containerButtonSideBar].join(" ")}><Link to="#" className={[styles.myLink, styles.myButtonSideBar].join(" ")}><i class="fa fa-file"></i>&nbsp;Lập báo cáo</Link></div>
        </div>
    );
}
